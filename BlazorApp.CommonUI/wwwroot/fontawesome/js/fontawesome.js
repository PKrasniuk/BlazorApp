...
(function() {
    ...
    function transformForSvg(_ref) {
        ...
        const innerScale = "scale(".concat(transform.size / 16 * (transform.flipX ? -1 : 1), ", ")
    ...
    var mutators = {
        ...
        nest: function nest(mutation) {
            const node = mutation[0];
            const
                abstract = mutation[1]; // If we already have a replaced node we do not want to continue nesting within it.
    ...
    function onTree(root) {
        ...
        const prefixesDomQuery = [".".concat(LAYERS_TEXT_CLASSNAME, ":not([").concat(DATA_FA_I2SVG, "])")].concat(
            ...
            if (alreadyProcessedPseudoElement && !fontFamily) {
                ...
                (!alreadyProcessedPseudoElement ||
                    ...
                    findIcon(iconName, prefix).then(function(main) {
                        const abstract = makeInlineSvgAbstract(_objectSpread({},
                            meta,
                            {
                                icons: {
                                    main: main,
