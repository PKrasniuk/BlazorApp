...
namespace BlazorApp.CommonUI.PageModels.Account
{
    public class LoginPageModel : ComponentBase
    {
        ...
        protected LoginModel LoginParameters { get; } = new LoginModel();

        protected ForgotPasswordModel ForgotPasswordParameters { get; } = new ForgotPasswordModel();
        ...
        protected override async Task OnParametersSetAsync()
        {
            ...
            {
                NavigationManager.NavigateTo(NavigationManager.BaseUri + NavigateTo, true);
            }
        }
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                await JsRuntime.InvokeVoidAsync("SetFocus", "userName");
            }
