...
namespace BlazorApp.CommonUI.Hubs
{
    ...
    {
        private static readonly Dictionary<string, ChatClient> Clients = new Dictionary<string, ChatClient>();
        ...
        public async Task Start()
        {
            if (!_started)
            {
                var _ = await _jsruntime.InvokeAsync<object>("ChatClient.Start", _key, "/chathub", "BlazorApp.CommonUI", "ReceiveMessage");
                _started = true;
